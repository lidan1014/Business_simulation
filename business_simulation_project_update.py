...
class Business_simulation:
    ...
    def simulate_customer_information(self,customer_id_gender_df):
        """
            Part 1:
        ...
        customer_information_df.columns = ["Customer_id", "Gender", "session_length"]
...
def main():
    ...
    # part1:
    customer_information_df = simulation_data.simulate_customer_information(customer_id_gender_df)
